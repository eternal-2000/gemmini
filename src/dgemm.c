...
void dgemm(transOpt transA, transOpt transB,
	   int m, int n, int p,
...
void proc_B_64(transOpt transA, transOpt transB,
	       int m, int n, int p,
	       double alpha, double* A, int ldA,
	       double* B, int ldB,
	       double* C, int ldC){
...
void proc_A_64(transOpt transA,
	       int m, int n, int p,
	       double* A, int ldA,
	       double* B_pack,
	       double* C, int ldC){
...
void macrokernel_64(int m, int n, int p,
