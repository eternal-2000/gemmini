#include<immintrin.h>
void kernel_dbl8x4(const int p, double* restrict A, double* restrict B, double* restrict C, const int ldC, double* restrict D
		   , const int ldD){  
  ...
  _mm256_store_pd(&D[0], c_0123_0);
  _mm256_store_pd(&D[4], c_4567_0);

  _mm256_store_pd(&D[ldD], c_0123_1);
  _mm256_store_pd(&D[4 + ldD], c_4567_1);

  _mm256_store_pd(&D[2 * ldD], c_0123_2);
  _mm256_store_pd(&D[4 + 2 * ldD], c_4567_2);

  _mm256_store_pd(&D[3 * ldD], c_0123_3);
  _mm256_store_pd(&D[4 + 3 * ldD], c_4567_3);
}
